...
"}")
        ...
        icon1.addPixmap(QtGui.QPixmap("Icon/checked.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon2.addPixmap(QtGui.QPixmap("Icon/addition-sign.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
