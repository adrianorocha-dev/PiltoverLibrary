...
"}")
        ...
        self.textBrowser_info.setGeometry(QtCore.QRect(300, 240, 256, 192))
        self.textBrowser_info.setObjectName("textBrowser_info")
        self.pushButton_atualizar = QtWidgets.QPushButton(Dialog)
        self.pushButton_atualizar.setGeometry(QtCore.QRect(300, 470, 80, 25))
        self.pushButton_atualizar.setObjectName("pushButton_atualizar")
        self.pushButton_cadastrar = QtWidgets.QPushButton(Dialog)
        self.pushButton_cadastrar.setGeometry(QtCore.QRect(469, 470, 91, 25))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_atualizar.setText(_translate("Dialog", "Atualizar"))
        self.pushButton_cadastrar.setText(_translate("Dialog", "Cadastrar livro"))
